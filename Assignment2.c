...
int main()
{
    ...
    printf("\nFindLargest: %d\n\n", FindLargest(A, rowsize, colsize));          //Prints largest number in 2D array A using FindLargest function
                                                                                    ...
                                                                                    //Transpose function will take values of A and set them to be with colsize for rows and rowsize for coloumns
    DisplayArray2D(Transpose(A, B, rowsize, colsize), colsize, rowsize);            //MUST put colsize in rowsize designation and rowsize in colsize designation or else will breach scope of B array
